...
func TestIoU(t *testing.T) {
	tests := []struct {
		...
		{
			name:     "No overlap",
			box1:     box{0.0, 0.0, 1.0, 1.0, CLASS_TEXT, 0.7},
			box2:     box{2.0, 2.0, 3.0, 3.0, CLASS_TEXT, 0.7},
			expected: 0.0,
		},
		{
			name:     "Complete overlap",
			box1:     box{0.0, 0.0, 1.0, 1.0, CLASS_TEXT, 0.7},
			box2:     box{0.0, 0.0, 1.0, 1.0, CLASS_TEXT, 0.7},
			expected: 1.0,
		},
		{
			name:     "Partial overlap",
			box1:     box{0.0, 0.0, 1.0, 1.0, CLASS_TEXT, 0.7},
			box2:     box{0.5, 0.5, 1.5, 1.5, CLASS_TEXT, 0.7},
			expected: 0.14285714285714285,
		},
		{
			name:     "One box inside another",
			box1:     box{0.0, 0.0, 2.0, 2.0, CLASS_TEXT, 0.7},
			box2:     box{0.5, 0.5, 1.5, 1.5, CLASS_TEXT, 0.7},
			expected: 0.25,
		},
	}
...
func TestIntersection(t *testing.T) {
	testCases := []struct {
		...
		{
			box{0.0, 0.0, 2, 2, CLASS_TEXT, 0.7},
			box{1, 1, 3, 3, CLASS_TEXT, 0.7},
			1,
		},
		{
			box{0, 0, 2, 2, CLASS_TEXT, 0.7},
			box{2, 2, 4, 4, CLASS_TEXT, 0.7},
			0,
		},
		{
			box{0, 0, 3, 3, CLASS_TEXT, 0.7},
			box{1, 1, 2, 2, CLASS_TEXT, 0.7},
			1,
		},
		{
			// Границы прямоугольников совпадают по одной стороне
			box{0, 0, 4, 4, CLASS_TEXT, 0.7},
			box{0, 0, 4, 5, CLASS_TEXT, 0.7},
			4 * 4,
		}, {
			// Один прямоугольник полностью содержит другой
			box{0, 0, 10, 10, CLASS_TEXT, 0.7},
			box{0, 0, 8, 8, CLASS_TEXT, 0.7},
			8 * 8,
		}, {
			box1:     box{0.0, 0.0, 1.0, 1.0, CLASS_TEXT, 0.7},
			box2:     box{0.5, 0.5, 1.5, 1.5, CLASS_TEXT, 0.7},
